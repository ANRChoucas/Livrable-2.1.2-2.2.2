 ...
 *
 */
public class FastDBSCAN implements ClusteringAlgorithm {
         ...
         */
        @Override
        public void doClustering(Dataset dataset) throws Exception {
         ...
         * @param minPoints2
         */
        private boolean expandCluster(int pointnumber, int currentClusterId, float gamma2, int minPoints2, Dataset dataset) throws Exception {
         ...
         */
        private Collection<Integer> getNeighbours(Dataset dataset, int id) throws Exception {
...
//                Collection <List<Integer>>closepoints = neigbourList.headMap(this.epsilon +0.0000000000000001f).values();  //56077472000f
//                Collection <List<Integer>>closepoints = neigbourList.headMap(this.epsilon + (float)Math.exp(0.5)).values(); // 2.72f    filter > epsilon + roArea. 
                //Collection <List<Integer>>closepoints = neigbourList.headMap(0.025f).values();
