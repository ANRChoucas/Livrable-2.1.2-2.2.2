...
public class Dataset implements Iterable<FeatureVector>{
         ...
         * @return
         */
        private void createSortedDistanceList() throws Exception {
                float dist;
         ...
         */
        public SortedMap<Float, List<Integer>>[] getNeighbourMatrix() throws Exception {
        ...
        private void createDistanceMatrix() {
                ...
                for (int i = 0; i < this.vectors.size() - 1; i++) {
                        for (int j = i + 1; j < this.vectors.size(); j++) {
                                ...
                                this.distanceMatrix[i][j] = distance;							//--- 1D
